...
if (isset($_POST['submit'])) {
    ...
    $checkDuplicateQuery = "SELECT * FROM `publishers` WHERE publisher_name = '$publisherName'";
    ...
    if (mysqli_num_rows($resultDuplicate) > 0) {
        ...
        $insertQuery = "INSERT INTO `publishers` (`publisher_name`) VALUES ('$publisherName')";
...
if (isset($_POST['edit'])) {
    $Id = $_POST['id'];
    $fetchQuery = "SELECT * FROM `publishers` WHERE id = $Id";
    $publisherData = mysqli_fetch_assoc(mysqli_query($conn, $fetchQuery));

    // Modal for updating publisher record
    echo '
        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content col-sm mx-3 my-3">
                    <div class="modal-header">
                        <h5 class="modal-title" id="updateModalLabel">Update Publisher Name</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form method="post" onsubmit="return validateForm();">
                            <input type="hidden" name="id" value="' . $publisherData['id'] . '">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10 mt-3">
                                    <label>Publisher Name</label>
                                    <input type="text" id="publisher_name" name="publisher_name" required="required" class="form-control form-control-sm" value="' . $publisherData['publisher_name'] . '" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm">
...
if (isset($_POST['update'])) {
    ...
    $updateQuery = "UPDATE `publishers` SET `publisher_name`='$publisherName' WHERE id = $Id";
            ...
            <section id="intro">
                ...
                <div class="container">
                    ...
                    <div class="title text-center text-md-start mt-5">
                        <h1 class="titlepage display-8"> <i class="lni lni-arrow-up-circle"></i> Add Publishers </h1>
                    </div>
                    ...
                    <div class="row my-3 align-items-center justify-content-center">
                        ...
                        <div class="card col-sm mx-3 my-3" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-title"> <i class="lni lni-arrow-up-circle"></i> Publisher Information</h4>
                                ...
                                <form method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10 mt-3">
                                            ...
                                            <input type="text" id="publisher_name" name="publisher_name" required="required" class="form-control form-control-sm" />
                                        </div>
                                    </div>
                    ...
                    <div class="row my-3 align-items-center justify-content-center">
                        ...
                        <div class="card col-sm mx-3 my-3" style="width: 18rem;">
                            ...
                            <div class="card-body d-flex justify-content-between">
                                ...
                                <h4 class="card-title"><i class="lni lni-arrow-up-circle"></i> Publishers</h4>
