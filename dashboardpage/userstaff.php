...
if (isset($_POST['add_staff'])) {
    ...
    $checkDuplicateQuery = "SELECT * FROM `staffuser` WHERE user_id = '$userId' OR email = '$email'";
    ...
    if (mysqli_num_rows($resultDuplicate) > 0) {
        ...
        $insertQuery = "INSERT INTO `staffuser` (`last_name`, `first_name`, `user_id`, `role`, `email`, `password`) VALUES ('$lastName', '$firstName', '$userId', '$role', '$email', '$password')";
...
$result = mysqli_query($conn, "SELECT * FROM `staffuser`");

// Update staff user
if (isset($_POST['edit'])) {
    $Id = $_POST['id'];
    $fetchQuery = "SELECT * FROM `staffuser` WHERE id = $Id";
    $staffData = mysqli_fetch_assoc(mysqli_query($conn, $fetchQuery));

    // Modal for updating staff user record
    echo '
        <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content col-sm mx-3 my-3">
                    <div class="modal-header">
                        <h5 class="modal-title" id="updateModalLabel">Update Staff User Information</h5>
                        ...
                        <form method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-12 mt-3">
                                    ...
                                    <input type="text" id="last_name" name="last_name" required="required" class="form-control form-control-sm" value="' . $staffData['last_name'] . '" />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 mt-3">
                                    <label>First Name</label>
                                    <input type="text" id="first_name" name="first_name" required="required" class="form-control form-control-sm" value="' . $staffData['first_name'] . '" />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 mt-3">
                                    <label>User ID</label>
                                    <input type="text" id="user_id" name="user_id" required="required" class="form-control form-control-sm" value="' . $staffData['user_id'] . '" />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 mt-3">
                                    <label>Role</label>
                                    <input type="text" id="role" name="role" required="required" class="form-control form-control-sm" value="' . $staffData['role'] . '" />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 mt-3">
                                    <label>Email</label>
                                    <input type="email" id="email" name="email" required="required" class="form-control form-control-sm" value="' . $staffData['email'] . '" />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 mt-3">
...
if (isset($_POST['update'])) {
    ...
    if ($password) {
        $updateQuery = "UPDATE `staffuser` SET `last_name`='$last_name', `first_name`='$first_name', `user_id`='$user_id', `role`='$role', `email`='$email', `password`='$password' WHERE id = $Id";
    } else {
        $updateQuery = "UPDATE `staffuser` SET `last_name`='$last_name', `first_name`='$first_name', `user_id`='$user_id', `role`='$role', `email`='$email' WHERE id = $Id";
    }
...
if (isset($_POST['delete'])) {
    ...
    $query = "DELETE FROM staffuser WHERE id = $Id";
            ...
            <section id="intro">
                ...
                <div class="container">
                    ...
                    <div class="title text-center text-md-start mt-5">
                        <h1 class="titlepage display-8"> <i class="lni lni-user"></i> Manage Library Staff</h1>
                    </div>
                    ...
                    <div class="row my-3 align-items-center justify-content-center">
                        ...
                        <div class="card col-sm mx-3 my-3" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-title"> <i class="lni lni-user"></i> Staff Information</h4>
                                ...
                                <form method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-12 mt-3">
                                            <label>Role</label>
                                            <input type="text" id="role" name="role" required="required" class="form-control form-control-sm" placeholder="Enter role" />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-12 mt-3">
                                            <label>Email</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 mt-3 text-center">
                                            <button type="submit" name="add_staff" id="add_student" class="btn btn-md float-end mt-3">Add staff</button>
                                        </div>
                                    </div>
                        ...
                        <div class="card col-sm mx-3 my-3" style="width: 100%em;">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="staffinfo" class="table table-bordered" role="grid" aria-describedby="all_courses_info">
                                        <thead>
                                            <tr>
                                                <th scope="col">ID</th>
